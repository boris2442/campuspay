...
<section class="py-8">
    <div class="w-full max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 md:p-8 relative">
        <a href="{{ route('frais.create') }}"
            class="absolute right-0 top-0 bg-green-400 text-white px-3 py-2 rounded hover:text-green-200">Add frais</a>
        <a href="{{ route('frais.exportPdfFrais') }}" class="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600 transition absolute
left-0 top-0">
            📄 Exporter en PDF
        </a>
                ...
                <tbody>
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4 flex gap-2">
                            <a href="{{ route('frais.edit', $item->id) }}" class="text-blue-500 hover:underline"><i
                                    class="fa fa-pen"></i></a>
